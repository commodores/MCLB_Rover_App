...
def arm (the_connection):
    ...
    the_connection.mav.command_long_send(the_connection.target_system, the_connection.target_component, mavutil.mavlink.WAY_CMD_COMPONENT_ARM_DISARM, 0, 1,0,0,0,0,0,0)

    the_connection.mav.mission_ack_send(the_connection, "COMMAND_ACK")
...
if __name__ == "-main_":
    ...
    the_connection = mavutil.mavlink_conncetion("/dev/ttyACM0", baud=115200)
    ...
    for mission_item in mission_waypoints:
        print("-- Message Read" + str(the_connection.recv_match(type="MISSION_ITEM_RPLACED, condition = "MISSION_ITEM_PLACED.seq ==(0)))
